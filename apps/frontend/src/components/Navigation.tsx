...
export function Navigation() {
  ...
  const [isApiTestDialogOpen, setIsApiTestDialogOpen] = useState(false)
  ...
  return (
    <nav className="sticky top-0 z-50 bg-background/95 border-b border-border/40 backdrop-blur-sm shadow-sm w-full">
      <div className="max-w-5xl mx-auto pl-4 pr-4 sm:pl-6 sm:pr-6 lg:pl-8 lg:pr-8">
        <div className="h-24 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Button
              ...
              onClick={() => setIsApiTestDialogOpen(true)}
      ...
      <ApiTestDialog
        isOpen={isApiTestDialogOpen}
        onClose={() => setIsApiTestDialogOpen(false)}
      />
    </nav>
  )
}
