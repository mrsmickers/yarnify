...
declare const parseZodValidationSchemaDefinition: (input: ZodValidationSchemaDefinition, context: ContextSpecs, coerceTypes?: boolean | ZodCoerceType[], preprocess?: GeneratorMutator) => {
    zod: string;
    consts: string;
};
